...
# -*- coding: utf-8 -*-
"""
RUYI-168 替换卡片 · Taste-Skill / ECC（1200×630）
输入: raw/ 下的官方渠道素材（来源与采集日期见 SOURCES.md）
输出: cards/*.png（2 张替换卡，原生分辨率，无放大）
...
ITEMS = [
    dict(out='01_taste-skill.png', type='SKILL', cat='创意与设计', name='Taste Skill',
         domain='tasteskill.dev', accent=(201, 162, 107),
         value='给 AI 装「品味」，抑制模板化平庸输出',
         license='MIT', stars='89,268', img='official_tasteskill_og-image.jpg',
         fit='fill', fx=.07, fy=.5,
         caption='视觉来源：tasteskill.dev 官方 OG 图 · 采集 2026-09-24'),
    dict(out='02_ecc.png', type='APP', cat='辅助工具', name='ECC',
         domain='ecc.tools', accent=(226, 168, 148),
         value='给编码 Agent 做性能优化的 harness 系统（技能、本能、记忆、安全一体）',
         license='MIT', stars='265,247', img='official_ecc_hero.png',
         fit='fill', precrop=(0, 0.111, 0.4167, 0.7037), fx=0,
         caption='视觉来源：ecc.tools 官方 Hero 图 · 采集 2026-09-24'),
]
