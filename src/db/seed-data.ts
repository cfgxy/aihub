...
serena init`,
  ...
  },
  {
    ...
    description: "Taste Skill 是一套给 AI agent「好品味」的前端技能集，定位直截了当：阻止 agent 生成平庸、通用、千篇一律的界面。在用 AI 产出前端的场景里，功能跑通之后真正拉开差距的是审美与细节，这个项目把「设计品味」当作一种可注入 agent 的能力来交付。核心能力覆盖三件事：在 agent 生成前端时施加反 slop 界面约束，以 SKILL 形式注入设计品味，并支持按具体项目的审美取向校准。官方提供独立网站 tasteskill.dev，安装走官方 README 给出的 npx skills add 命令。效果主观，需按项目调校；README 含 Kimi（Moonshot AI）赞助位，引用素材时注意识别性引用边界；具体技能清单与版本号以官方仓库 README 为准。MIT 开源、免费。",
  ...
  {
    name: "DeepSeek Harness", slug: "deepseek-harness", type: "app", category: "official-apps",
    summary: "DeepSeek 官方插件化智能体运行时：Everything is a Plugin，建仓约 6 周即现象级开源。",
    description: "DeepSeek Harness 是 DeepSeek 官方出品的智能体（Agent）运行时，围绕插件化机制组织能力——「Everything is a Plugin」，功能扩展通过插件完成。对关注智能体运行时的团队，它是观察 DeepSeek 官方 agent 技术路线的直接入口。项目以 MIT 许可证开源，可免费使用与二次开发。项目于 2026-08-13 建仓，约 6 周 GitHub 星数即达 235,055（2026-09-25 快照），最近一次推送为 2026-09-24，是本期 GitHub 上的现象级项目；同时其发布周期尚短，接口与插件规范可能快速变化，采用时建议锁定版本、关注官方更新，运行所需模型与用量成本未知。DeepSeek 官方条目此前在库缺位，本条为插件化智能体运行时，与在库各编程 agent 条目定位不同。",
    tags: ["官方出品", "开源", "MIT", "智能体运行时", "插件化", "Agent"],
    officialUrl: "https://deepseek.com/harness", sourceUrl: "https://github.com/deepseek-ai/deepseek-harness",
    updatedAt: "2026-09-25",
  },
  {
    name: "Impeccable", slug: "impeccable", type: "skill", category: "creative-design",
    summary: "提升编程 agent 前端设计质量的设计语言：24 命令、61 条检测规则。",
    description: "Impeccable 是一套用于提升编程 agent 前端输出质量的设计语言，以技能（Skill）形式提供，包含 24 个命令与 61 条检测规则，让 AI 编程工具在生成界面时遵循统一的设计标准。对日常用 AI 写前端的开发者，它的思路是把「界面质量」从口头要求变成可执行的规则约束：设计语言给出标准，检测规则在产出环节把关。项目以 Apache-2.0 许可证开源，免费可用。规则型技能的实际效果随目标 harness 与模型而异（未知项），建议在自己的常用环境中实测后再决定是否固化进工作流。与在库 HyperFrames、Taste Skill 同为前端质量方向，但切入点不同——本条是设计语言与检测规则，不是框架或反 slop 清单。",
    tags: ["社区出品", "开源", "Apache-2.0", "SKILL", "前端设计", "设计语言", "检测规则"],
    officialUrl: "https://impeccable.style", sourceUrl: "https://github.com/pbakaus/impeccable",
    installGuide: `npx impeccable install`,
    updatedAt: "2026-09-25",
  },
  {
    name: "CLI-Anything", slug: "cli-anything", type: "app", category: "companion-tools",
    summary: "让任意软件通过 CLI 对 AI agent 可用，附 CLI-Hub 包管理器与生成器。",
    description: "CLI-Anything 出自 HKUDS，目标是让任意软件都能通过命令行（CLI）被 AI agent 调用：把原本只能图形界面操作的软件封装为 agent 可用的 CLI 接口，并配套 CLI-Hub 包管理器与生成器，覆盖封装的获取与生成。它与「截屏点按」式桌面操控是两种互补形态：本条走 CLI 化路线，以命令行这一结构化接口承载软件操作。项目以 Apache-2.0 许可证开源，免费可用。需要注意，这类工具会把本地软件的操作权限交给 agent，安全边界须由用户自行评估——建议从低风险软件开始试用，并控制 agent 的操作范围；维护持续性未知。",
    tags: ["社区出品", "开源", "Apache-2.0", "CLI 化", "自动化", "HKUDS", "软件 Agent 化"],
    officialUrl: "https://clianything.cc", sourceUrl: "https://github.com/HKUDS/CLI-Anything",
    updatedAt: "2026-09-25",
  },
  {
    name: "Codebase Memory MCP", slug: "codebase-memory-mcp", type: "mcp", category: "development-code",
    summary: "把代码库索引为持久知识图谱的高性能代码智能 MCP 服务器，覆盖 158 种语言。",
    description: "Codebase Memory MCP 是一个高性能代码智能 MCP 服务器：把整个代码库索引为持久知识图谱，覆盖 158 种编程语言，让 AI agent 具备跨文件、跨模块的全局代码理解与可持久复用的检索能力。对维护大型代码库的团队，它解决的是「agent 每次都要重新读代码」的问题：索引一次、持久复用。项目以 MIT 许可证开源，免费可用。大型仓库上的索引资源占用与检索准确率仍是未知项，建议在真实仓库小规模试点后再扩大范围。它与在库 serena 同属代码智能赛道，但产品与仓库不同：本条以 MCP 服务器形态提供持久知识图谱。",
    tags: ["社区出品", "开源", "MIT", "MCP", "代码智能", "知识图谱", "代码检索"],
    officialUrl: "https://deusdata.github.io/codebase-memory-mcp", sourceUrl: "https://github.com/DeusData/codebase-memory-mcp",
  ...
  {
    name: "Claude Code Templates", slug: "claude-code-templates", type: "app", category: "others",
    summary: "一键配置与监控 Claude Code 的 CLI 模板库：100+ 智能体、命令、hooks 与 MCP 集成。",
    description: "Claude Code Templates 是一个用于一键配置与监控 Claude Code 的 CLI 模板库，内置 100+ 智能体、命令、hooks 与 MCP 集成，帮用户跳过从零配置的过程，直接套用社区沉淀的工作流模板，价值在「起点质量」：常见工作流场景都有现成模板可改。项目以 MIT 许可证开源，免费可用。使用时须注意：社区模板质量参差，安装前应自行审查内容；该项目为社区项目，与 Anthropic 无隶属关系。在库此前无同类 Claude Code 模板集条目。",
    tags: ["社区出品", "开源", "MIT", "Claude Code", "模板库", "工作流配置", "hooks"],
    officialUrl: "https://aitmpl.com", sourceUrl: "https://github.com/davila7/claude-code-templates",
    updatedAt: "2026-09-25",
  },
  {
    name: "Strands Harness SDK", slug: "strands-harness-sdk", type: "app", category: "others",
    summary: "生产级 agent 开发 SDK：Python/TypeScript 双语言、任意模型、任意云。",
    description: "Strands Harness SDK 是面向生产环境的智能体开发 SDK，支持 Python 与 TypeScript 双语言，主打「任意模型、任意云」，不绑定特定模型供应商或云平台。与偏应用的 agent 框架不同，SDK 的定位是给后端与平台工程师提供构建生产级 agent 的工程底座。项目以 Apache-2.0 许可证开源，免费可用。项目创建于 2025 年 5 月，是本期热度回升进入日榜的老项目（老项目热度回升入选先例：WeKnora）；其生产采用案例目前未知，评估时建议结合自身场景做验证性试点。与在库 Agent-Native（应用框架）定位不同，本条是开发 SDK。",
    tags: ["社区出品", "开源", "Apache-2.0", "Agent SDK", "Python", "TypeScript", "跨云"],
    officialUrl: "https://strandsagents.com", sourceUrl: "https://github.com/strands-agents/harness-sdk",
    updatedAt: "2026-09-25",
  },
  {
    name: "teamai-cli", slug: "teamai-cli", type: "skill", category: "enterprise-collaboration",
    summary: "腾讯开源：把团队 Prompt/Skill/规则/上下文纳入 Git 管理与评审的 CLI。",
    description: "teamai-cli 是腾讯开源的命令行工具，把团队的 Prompt、Skill、规则与上下文等 AI 协作资产纳入 Git 管理与评审流程，让散落各处的「AI 资产」像代码一样版本化、可追溯、可评审。团队级 AI 资产管理在库中尚无同类条目，这是它的差异化价值。需要特别提示：该项目的许可证为腾讯自定义条款，并非标准 SPDX 命名——有报道称其为 MIT，但与仓库 LICENSE 实文不符，以仓库 LICENSE 为准，商用细则未知；采用前建议由团队负责人或法务确认许可条款。它与在库 WeKnora 同为腾讯出品，但是不同产品。",
    tags: ["社区出品", "开源", "自定义许可", "SKILL", "团队协作", "Git 管理", "AI 资产"],
    officialUrl: "https://github.com/Tencent/teamai-cli", sourceUrl: "https://github.com/Tencent/teamai-cli",
    installGuide: `npm install -g teamai-cli`,
    updatedAt: "2026-09-25",
  },
  {
    name: "Substrate", slug: "substrate", type: "app", category: "others",
    summary: "默认安全的 agent 沙箱执行运行时：microVM/gVisor 沙箱、亚秒级恢复。",
    description: "Substrate 是一个「默认安全」的 agent 沙箱执行运行时：以 microVM 与 gVisor 沙箱隔离 agent 任务，支持亚秒级恢复，让 agent 任务的执行被约束在受控环境中。随着 agent 被授予的执行权限越来越多，「怎么跑得安全」成为基础设施层问题，Substrate 正面向这一层；agent 基础设施方向在库中尚无同类条目。项目以 Apache-2.0 许可证开源，免费可用。项目创建于 2026 年 5 月，体量尚小，生产成熟度未知，适合先在非关键链路上评估。",
    tags: ["社区出品", "开源", "Apache-2.0", "沙箱", "Agent 基础设施", "microVM", "安全隔离"],
    officialUrl: "https://github.com/agent-substrate/substrate", sourceUrl: "https://github.com/agent-substrate/substrate",
    updatedAt: "2026-09-25",
  },
  {
    name: "Treg", slug: "treg", type: "app", category: "companion-tools",
    summary: "「工具版 OpenRouter」：一个 base URL 调用 60+ 供应商 3000+ 端点，按次计费、可自托管。",
    description: "Treg 被称为「工具版 OpenRouter」：通过一个 base URL，让 agent 调用 60+ 供应商的 3000+ 端点，把 SEO、数据增强、抓取、图像生成等外部工具能力聚合为统一入口，并支持自托管。「工具聚合注册表」形态在库中尚无同类条目。定价分两层：自托管免费，托管目录端点按次计费。需要提示：该项目许可证为非标准 SPDX 命名，具体授权条款以仓库为准；其聚合的第三方数据源合规与计费政策可能变化，接入前建议自行确认。",
    tags: ["社区出品", "开源", "自定义许可", "工具聚合", "API 网关", "自托管", "OpenRouter"],
    officialUrl: "https://treg.to", sourceUrl: "https://github.com/superdesigndev/treg",
    updatedAt: "2026-09-25",
  },
  {
    name: "PanWatch（盯盘侠）", slug: "panwatch", type: "app", category: "others",
    summary: "自托管 AI 盯盘助手：A股/港股/美股实时监控 + TradingAgents 多 agent 决策。",
    description: "PanWatch（盯盘侠）是一个可自托管的 AI 盯盘助手，覆盖 A股、港股、美股三个市场的实时监控，并集成 TradingAgents 多 agent 决策引擎。它与历史候选 TradingAgents（RUYI-144，未获批）不同仓、不同品：本条是集成 TradingAgents 决策引擎的完整应用，适合想在本地自建多市场盯盘助手的个人用户。项目以 MIT 许可证开源，免费可用。必须提示：其输出属于金融决策辅助信息，不构成投资建议；行情数据源的合规性与接口稳定性也属未知项，使用前请自行确认数据来源并控制风险。",
    tags: ["社区出品", "开源", "MIT", "金融工具", "盯盘", "自托管", "多 agent"],
    officialUrl: "https://github.com/TNT-Likely/PanWatch", sourceUrl: "https://github.com/TNT-Likely/PanWatch",
    updatedAt: "2026-09-25",
  },
  {
    name: "Kimi Code CLI", slug: "kimi-code", type: "app", category: "official-apps",
    summary: "月之暗面官方开源的终端编码 Agent：单二进制零 Node 安装，v2.0 附桌面版。",
    description: "Kimi Code CLI 是月之暗面（MoonshotAI）官方开源的终端编码 Agent，以单个二进制文件分发，安装不依赖 Node 环境。项目创建于 2026-05-22，2026-09-17 发布 v2.0 并同步推出 macOS/Windows 桌面版，旧项目 kimi-cli 已归档、由本项目替代。GitHub 2026-09-26 快照 ★7,670，最近推送 09-25，维护活跃。它的辨识度来自「国产模型厂商官方开源编码 Agent」这一身份，以及几处工程细节：支持视频输入；可通过 /mcp-config 以对话方式完成 MCP 配置；npm 包 @moonshot-ai/kimi-code（2.1.0，MIT）提供安装通道。在目录中它与在库 Codex、Claude、ZCode 等编码智能体同类，以国产模型官方开源形成差异。",
    tags: ["官方出品", "开源", "MIT", "编码智能体", "CLI", "桌面版", "MCP 配置"],
    officialUrl: "https://github.com/MoonshotAI/kimi-code", sourceUrl: "https://github.com/MoonshotAI/kimi-code",
    updatedAt: "2026-09-26",
  },
  {
    name: "Archify", slug: "archify", type: "skill", category: "development",
    summary: "让编码 Agent 画出的架构图可验证：typed JSON IR 经确定性编译，9 项校验 fail-closed。",
    description: "Archify 让编码 Agent 产出的架构图变得「可验证」：AI 画图不再只是「看起来对」，而是走一条有中间表示、有质量门禁的流水线——typed JSON IR 经确定性编译，生成架构、时序、数据流等五类图，并通过 9 项校验以 fail-closed 方式交付。GitHub 2026-09-26 快照 ★71,604（MIT），最近推送 09-25。增长方面，DEV Community 评测（09-14）称其为当时「当前增长最快的 agent skill」，彼时 ★61,519、周增约 10,100；技术栈日榜（09-18）记录其 24h +1,002。它支持 Cursor、Claude Code、Codex CLI、OpenCode 等编码 Agent。与在库 HyperFrames 同属 agent 出图，差异点在验证门与工程评审场景。",
    tags: ["社区出品", "开源", "MIT", "SKILL", "架构图", "可验证出图", "质量门禁"],
    officialUrl: "https://github.com/tt-a1i/archify", sourceUrl: "https://github.com/tt-a1i/archify",
    installGuide: "npx skills add tt-a1i/archify -g",
    updatedAt: "2026-09-26",
  },
  {
    name: "AgentGateway", slug: "agentgateway", type: "mcp", category: "cloud-infrastructure",
    summary: "Agent 与 MCP 双代理网关：为 agent 到模型/MCP 流量提供统一鉴权与策略管理。",
    description: "AgentGateway 是面向 AI Agent 与 MCP 服务器的下一代代理网关，为 agent 到模型/MCP 的流量提供统一鉴权与策略管理。项目创建于 2025-03，并非全新项目，近期热度明显上升：GitHub 2026-09-26 快照 ★5,041（Apache-2.0），最近推送 09-25，日推送活跃。定位上它是基础设施型项目：agent 与 MCP 双代理网关，在库此前没有同类网关条目，属于空白补位。需要特别说明的是，它与 RUYI-164 期提名未获批的「Open MCP Gateway」定位相近，但为不同项目（不同名、不同仓库），收录与引用时不应混淆。",
    tags: ["社区出品", "开源", "Apache-2.0", "MCP", "Agent 网关", "统一鉴权", "策略管理"],
    officialUrl: "https://github.com/agentgateway/agentgateway", sourceUrl: "https://github.com/agentgateway/agentgateway",
    updatedAt: "2026-09-26",
  },
  {
    name: "Wigolo", slug: "wigolo", type: "mcp", category: "search-web",
    summary: "本地优先的网络研究 MCP：search/fetch/crawl/research 四合一，零 API key。",
    description: "Wigolo 是一个本地优先的网络研究 MCP 服务器，把搜索（search）、抓取（fetch）、爬取（crawl）与研究（research）四类能力集于一体，且零 API key——无需逐家申请、配置搜索服务的密钥，即可让 Agent 在本地完成网络研究链路。GitHub 2026-09-26 快照 ★5,405，最近推送 09-25，项目创建于 2026-04-12。与在库 Firecrawl Skill（托管抓取服务）场景相邻但形态不同：Wigolo 走本地运行路线。需要提醒的是，其许可证为自定义条款（未识别），本条目如实标注，商用前请自行审阅许可证原文。",
    tags: ["社区出品", "开源", "自定义许可", "MCP", "网络研究", "本地优先", "零 API key"],
    officialUrl: "https://github.com/KnockOutEZ/wigolo", sourceUrl: "https://github.com/KnockOutEZ/wigolo",
  ...
  {
    name: "OpenSpec", slug: "openspec", type: "app", category: "others",
    summary: "面向 AI 编码助手的规格驱动开发（SDD）工作流工具，在库该类目第一条。",
    description: "OpenSpec 是面向 AI 编码助手的规格驱动开发（Spec-Driven Development，SDD）工作流工具。项目创建于 2025-08，并非全新项目，但热度明显上升：GitHub 2026-09-26 快照 ★70,336（MIT），最近推送 09-25。在本期目录中，它的价值在于定位空白：在库 91 条种子数据中没有 SDD 工作流类工具，OpenSpec 是该类目的第一个条目，为「用 AI 编码助手做规范驱动开发」的团队提供工作流支撑。",
    tags: ["社区出品", "开源", "MIT", "规格驱动开发", "SDD", "开发工作流"],
    officialUrl: "https://github.com/Fission-AI/OpenSpec", sourceUrl: "https://github.com/Fission-AI/OpenSpec",
    updatedAt: "2026-09-26",
  },
  {
    name: "OmniRoute", slug: "omniroute", type: "app", category: "companion-tools",
    summary: "MIT 开源模型网关：单端点聚合多供应商（自述 359 家/1200+ 模型），统一切换管理。",
    description: "OmniRoute 是一个 MIT 开源的模型网关：把多家模型供应商的调用收敛到单一端点。按项目自述，它聚合 359 家供应商、1200+ 模型，其中自称 150+ 免费——该组数字为官方 README 自述，未逐一核实，引用时请注意。GitHub 2026-09-26 快照 ★70,129，最近推送 09-25。适合在多个模型之间切换、不想为每家供应商单独维护接入方式的开发者：一个端点统一切换与管理。与在库 CCSwitch（本地配置切换器）形态不同：OmniRoute 是网关，CCSwitch 是配置切换器。另需注意「免费额度聚合」可能涉及供应商服务条款的合规性，使用前应自行确认相关条款。",
    tags: ["社区出品", "开源", "MIT", "模型网关", "多供应商", "单端点聚合", "OpenAI 兼容"],
    officialUrl: "https://github.com/diegosouzapw/OmniRoute", sourceUrl: "https://github.com/diegosouzapw/OmniRoute",
    updatedAt: "2026-09-26",
  },
  {
    name: "OpenCut", slug: "opencut", type: "app", category: "others",
    summary: "开源视频编辑器，定位 CapCut 开源替代；本期应用类星数最高（★90,662）。",
    description: "OpenCut 是开源的视频编辑器，定位为 CapCut 的开源替代。项目创建于 2025-06，GitHub 2026-09-26 快照 ★90,662（MIT），最近推送 09-24，是本期候选中星数最高的应用类条目。在本期目录中，它与在库视频类目形成互补：在库视频工具此前均为自动化/单点工具（jianying-headless、AutoClip 等），没有通用开源编辑器，OpenCut 补上了这个位置。功能成熟度为未知项：作为已运行一年以上的项目，其实际完成度请以官方仓库当前状态自行评估。",
    tags: ["社区出品", "开源", "MIT", "视频编辑", "CapCut 替代", "开源编辑器"],
    officialUrl: "https://github.com/OpenCut-app/OpenCut", sourceUrl: "https://github.com/OpenCut-app/OpenCut",
    updatedAt: "2026-09-26",
  },
  {
    name: "OpenCreator", slug: "opencreator", type: "app", category: "others",
    summary: "KrillinAI 更名转型之作：面向创作者的开源 AI 工作台（自述 powered by Codex）。",
    description: "OpenCreator 是 KrillinAI 更名转型后的新形态：面向创作者的开源 AI 工作台，官方 README 自述「Formerly KrillinAI」并标注 powered by Codex。GitHub 2026-09-26 快照 ★12,358（Apache-2.0），最近推送 09-24。本次入选属于「重要更新」情形：从原有产品（KrillinAI）更名并转型为创作者 AI 工作台，方向变化重大。它与在库视频单点工具不重复；但新形态的功能范围与成熟度为未知项，请以官方仓库当前说明为准。",
    tags: ["社区出品", "开源", "Apache-2.0", "创作工作台", "AI 工作台", "重大转型"],
    officialUrl: "https://github.com/krillinai/OpenCreator", sourceUrl: "https://github.com/krillinai/OpenCreator",
    updatedAt: "2026-09-26",
  },
  {
    name: "Nasiko", slug: "nasiko", type: "app", category: "others",
    summary: "AI Agent 的开发者控制面（Developer Control Plane），面向多 Agent 管理场景。",
    description: "Nasiko 是 AI Agent 的开发者控制面（Developer Control Plane），面向需要管理多个 AI Agent 的开发团队。GitHub 2026-09-26 快照 ★8,896，项目创建于 2026-02-12。「Agent 开发者控制面」这一定位在库为空白。需要注意两点：其一，核实期间该项目最近推送为 09-14，在本期候选中略旧；其二，许可证为自定义条款（未识别），商用前请自行审阅许可证原文。",
    tags: ["社区出品", "开源", "自定义许可", "Agent 控制面", "多 Agent 管理", "开发团队"],
    officialUrl: "https://github.com/Nasiko-Labs/nasiko", sourceUrl: "https://github.com/Nasiko-Labs/nasiko",
    updatedAt: "2026-09-26",
  },
  {
    name: "Skills（Matt Pocock）", slug: "skills", type: "skill", category: "development",
    summary: "TypeScript 知名教育者 Matt Pocock 开源的个人 .agents 工程技能集（全期星数最高）。",
    description: "这是 TypeScript 社区知名教育者 Matt Pocock 直接开源的个人 .agents 技能目录——一位「真实工程师」在用的工程技能集合。GitHub 2026-09-26 快照 ★269,586（MIT），最近推送 09-24，是本期候选中星数最高者；项目创建于 2026-02-03。与在库 Superpowers 等同为技能集合，其差异化依据在报批时已如实列明并由 Owner 裁量收录。对想直接复用成熟工程技能的 AI 编码用户而言，它提供的是一个知名教育者真实使用的技能目录开源快照。",
    tags: ["社区出品", "开源", "MIT", "SKILL", "工程技能集", "TypeScript", "技能目录"],
    officialUrl: "https://github.com/mattpocock/skills", sourceUrl: "https://github.com/mattpocock/skills",
